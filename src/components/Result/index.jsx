        ...
        <div className="flex flex-wrap justify-center">
            <div className="flex text-xs text-center md:text-base justify-center">
                <div className="bg-white p-10 rounded-lg shadow-md">
                    ...
                    <div className="mt-4">
                        <p className="text-4xl font-bold text-secondary-100">{`Total Marks ${progressBar}`}</p>
                    </div>
                    <div className="mt-4 mb-5">
                        <p className="text-gray-600 text-2xl font-bold text-secondary-100">{user.user.name}</p>
                    </div>
