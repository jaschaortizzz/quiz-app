        ...
        <div className="max-w-md w-full space-y-8">
          ...
          {/* <div className="flex flex-row justify-center items-center space-x-3">
            <a href="/" target="_blank"
              className="w-11 h-11 items-center justify-center inline-flex rounded-2xl font-bold text-lg   bg-blue-900 hover:shadow-lg cursor-pointer transition ease-in duration-300" rel="noreferrer"><img
                className="w-4 h-4"
                alt="img1"
            ...
            <a href="/" target="_blank"
              className="w-11 h-11 items-center justify-center inline-flex rounded-2xl font-bold text-lg  text-white bg-blue-400 hover:shadow-lg cursor-pointer transition ease-in duration-300" rel="noreferrer"><img
                className="w-4 h-4"
                alt="img2"
            ...
            <a href="/" target="_blank"
              className="w-11 h-11 items-center justify-center inline-flex rounded-2xl font-bold text-lg  text-white bg-blue-500 hover:shadow-lg cursor-pointer transition ease-in duration-300" rel="noreferrer"><img
